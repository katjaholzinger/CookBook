...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ingredients.add(new Ingredient("Farfalle", 500, "Gramm" ));
        ingredients.normalize(4);

        Recipe recipe = new Recipe("Farfalle", ingredients, 4, "pasta", "Wasser mit Salz zum kochen bringen. Wenn das Wasser kocht, die Farfalle dazugeben. Nach 12 Minuten das Wasser abgießen und die Nudeln abschrecken.");
